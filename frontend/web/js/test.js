...
{
  var url = "/intern-yktlj-tadbir/frontend/modules/pentadbiran/tuntutan/get-checkin-tahunan";
}
...
$.ajax({
    ...
    success: function (doc) {
        $(doc).each(function() {
            ...
            {
                id: $(this).attr('id'),
                startDate: new Date($(this).attr('makt_mod_tarikh_tuntutan')),
                color: color,
            }
...
$(function() {
    ...
    calendar = new Calendar('#calendar', { 
        ...
        selectRange: function(e) {
            editEvent({ startDate: e.startDate});
        },
